...
# Generate February data
february_spending = generate_monthly_spending('2024-02-01', 43)
print(february_spending)
february_spending.to_csv('febuary_spending.csv', index=False)