...
# Get March data
march_df = pd.read_csv('spending data/march_spending.csv')

# Calculate total spending by category
category_spending = march_df.groupby('Product')['Price'].sum().sort_values(ascending=True)

# Calculate total spending
total_spending = march_df['Price'].sum()
...
fig = px.bar(
    ...
    orientation='h',
    title='March 2024 - Spending by Category',
