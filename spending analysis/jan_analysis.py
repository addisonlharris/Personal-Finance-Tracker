...
# Get January data
jan_df = pd.read_csv('spending data/jan_spending.csv')

# Calculate total spending by category
category_spending = jan_df.groupby('Product')['Price'].sum().sort_values(ascending=True)

# Calculate total spending
total_spending = jan_df['Price'].sum()
...
fig = px.bar(
    ...
    orientation='h',
    title='January 2024 - Spending by Category',
